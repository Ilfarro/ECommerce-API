...
class ItemsAuthenticated(Resource):
    ...
    @jwt_required
    def post(self):
        users_id = get_jwt_claims()["users_id"]
        parser = reqparse.RequestParser()
...
api.add_resource(ItemsAuthenticated, '/users/items', '/users/items/<int:items_id>')
api.add_resource(ItemsPublic, '/public/items', '/public/items/<int:items_id>')